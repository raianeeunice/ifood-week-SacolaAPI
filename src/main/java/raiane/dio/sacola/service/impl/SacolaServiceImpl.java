package raiane.dio.sacola.service.impl;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import raiane.dio.sacola.enumeration.FormaPagamento;
import raiane.dio.sacola.model.Item;
import raiane.dio.sacola.model.Restaurante;
import raiane.dio.sacola.model.Sacola;
import raiane.dio.sacola.repository.ProdutoRepository;
import raiane.dio.sacola.repository.SacolaRepository;
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        if (itensDaScola.isEmpty()) {
            ...
            if (restauranteAtual.equals(restauranteDoItemParaAdicionar)) {
                ...
                throw new RuntimeException("Não é possível adicionar produtos de restaurantes diferentes. Feche a sacola ou esvazie-a.");
            }
        }
